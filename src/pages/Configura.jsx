...
export default function Configura() {
  ...
  const [context, setContext] = useState("hogar");
        ...
        <div className="mt-8 rounded-xl border bg-card p-6 md:p-8 space-y-8">
          ...
          <div className="rounded-lg bg-primary-soft border border-primary/20 p-4 flex gap-3 text-sm">
            ...
            <p className="text-foreground/80">
              ...
              La historia que estás por iniciar contiene descripciones sobre violencia. Puedes detenerte o usar el botón de "Salida Rápida" en cualquier momento si te sientes incómodo/a.
            </p>
          </div>

          <div className="flex items-center justify-between pt-2">
            <Link to="/" className="text-sm text-muted-foreground hover:text-foreground">Volver al inicio</Link>
            <Link to="/historia" className="inline-flex items-center gap-2 rounded-md bg-primary px-5 py-2.5 text-primary-foreground font-medium hover:bg-primary/90 transition">
