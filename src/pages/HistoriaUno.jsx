      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-10 border-t pt-6 flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <Link to="/historiaDos" className="inline-flex items-center gap-2 rounded-md bg-primary px-5 py-2.5 text-primary-foreground font-medium hover:bg-primary/90">
